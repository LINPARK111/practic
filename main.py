...
data2 = {"city":{"value":city,"color":get_random_color()},"birthday":{"value":birthday,"color":get_random_color()},"date":{"value":today,"color":get_random_color()}}
res = wm.send_template(user_id, template_id, data, data2)
print(res)
